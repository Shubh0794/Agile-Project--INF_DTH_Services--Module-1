...
<body>
            ...
            <form name="editInformation" method = "post" action = "LoginRegister" onsubmit="validate_operator(); return false">
                <div>
                    ...
                    <input class="form-control" type="text" placeholder="Enter first name" name="operator_firstname"
                        id="firstname" value="${operator.firstName}">
                    <br>
                </div>
                ...
                <div>
                    ...
                    <input class="form-control" type="text" placeholder="Enter last name" name="operator_lastname"
                        id="lastname" value="${operator.lastName}">
                    <br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" name="operator_email"
                        aria-describedby="emailHelp" placeholder="Enter email" value="${operator.email}">
                </div>

                <div>
                    <label for="phone"> <b>Phone Number</b> </label>
                    <input class="form-control" type="text" placeholder="Enter phone number" name="operator_phone"
                        id="phone" value="${operator.phone}">
                    <br>
                </div>
 ...
 -->
                ...
                <div>
                    ...
                    <input type="text" name="operator_maxCustomers" id="maxCustomers" min="1" max="20" value="${operator.totalCustomer}">
                </div>
                ...
                <div>
                    ...
                    <input class="form-control" type="hidden" name="operator_userid" id="userId" value="${operator.userId}">
                    <br>
                </div>

                <button type="submit" value="updateoperator" name="submit" class="btn btn-primary" id="btnRegister"
